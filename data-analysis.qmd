...
## **5.1 Building a Spatial Index** {#5.1-building-a-spatial-index}
...
## **5.2 Running a Cluster Analysis** {#5.2-running-a-cluster-analysis}
...
To run a cluster analysis on the currently selected BaseData object, select *Cluster* from the *Analyses* menu:![][image32]
...
* The lower (*Spatial calculations to run for each cluster node*) determines what subsequent calculations will be run for each node in this tree, using the groups it contains to define the spatial sample.  This allows you to, for example, calculate the phylogenetic diversity of the regions defined by each cluster node. 
  ...
  ### **5.2.1 Setting cluster analysis parameters** {#5.2.1-setting-cluster-analysis-parameters}
...
### **5.2.2 Viewing the cluster results** {#5.2.2-viewing-the-cluster-results}
...
## **5.3 Running a Spatial (Moving Window) Analysis** {#5.3-running-a-spatial-(moving-window)-analysis}

### **5.3.1 Introduction** {#5.3.1-introduction}
...
### **5.3.2 Setting the Spatial Analysis Options** {#5.3.2-setting-the-spatial-analysis-options}
...
### **5.3.3 Selecting indices to calculate** {#5.3.3-selecting-indices-to-calculate}
...
### **5.3.4 Viewing the Spatial Analysis Results** {#5.3.4-viewing-the-spatial-analysis-results}
...
### **5.3.5 Running analysis with local neighbours** {#5.3.5-running-analysis-with-local-neighbours}
...
## **5.4 Running a Randomisation Analysis** {#5.4-running-a-randomisation-analysis}
...
### **5.4.2 Spatially Structured Randomisations** {#5.4.2-spatially-structured-randomisations}
