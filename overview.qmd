...
You can access a range of Biodiverse Help Topics by clicking on the Help option on the menu bar within the Biodiverse application (see images/image below). You can also hover the mouse pointer over most buttons and menu items in Biodiverse to view their associated tooltips. 
...
You can also send questions to the Biodiverse discussion forum at [https://github.com/shawnlaffan/biodiverse/discussions](https://github.com/shawnlaffan/biodiverse/discussions) or at [https://groups.google.com/forum/\#\!forum/biodiverse-users](https://groups.google.com/forum/#!forum/biodiverse-users). We welcome any queries, comments or feedback. 
