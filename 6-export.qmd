...
# **6\. Exporting and Saving** {#6.-exporting-and-saving}

## **6.1 Saving a Project** {#6.1-saving-a-project}
...
## **6.2 Exporting results, groups and labels** {#6.2-exporting-results,-groups-and-labels}
